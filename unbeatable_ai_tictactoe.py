...
def main():
    ...
    def minimax(board, depth, maximizingPlayer, game_logic, best_row, best_col):
        ...
        if maximizingPlayer:
            ...
            for row in range(3):
                for col in range(3):
                    if board[row][col] == None:
                        board[row][col] = 'x'
                        res = minimax(board, depth - 1, False, game_logic, best_row, best_col)[0]
                        if res > value:
                            value = res
            ...
            for row in range(3):
                for col in range(3):
                    if board[row][col] == None:
                        board[row][col] = 'o'
                        res = minimax(board, depth - 1, True, game_logic, best_row, best_col)[0]
                        if res < value:
                            value = res
                            best_row, best_col = row, col
                        board[row][col] = None
        ...
        for event in pygame.event.get():
            ...
            if cross:
                if first_move:
                    ...
                    best_row, best_col = minimax(board, 15, True, game_logic, best_row, best_col)[1:]
